...
public class Settings implements Serializable{
	...
	public Double major_max_length = 80.0;
	
	/** Minimálná délka hlavní ulice. */
	public Double major_min_length = 60.0;
	...
	public Double major_close_node_constant = 10.0;
	
	/** Urèuje, jak blízko mùe bıt hlavní uzel nìjaké ulici. */
	public Double major_close_street_constant = 10.0;
	
	/** Urèuje, jak blízko mùe bıt vedlejší uzel nìjakému jinému uzlu. */
	public Double minor_close_node_constant = 10.0;
	
	/** Urèuje, jak blízko mùe bıt vedlejší uzel nìjaké ulici.  */
	public Double minor_close_street_constant = 10.0;
